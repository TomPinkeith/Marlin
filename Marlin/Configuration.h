...
#define STRING_CONFIG_H_AUTHOR "By TomPinkeith" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "KLP"
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -14.750 }
...
#define HOMING_FEEDRATE_Z  (80*80)
