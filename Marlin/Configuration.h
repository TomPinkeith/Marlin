...
#define STRING_SPLASH_LINE2 "by TomPinkeith"    // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Linear Plus"
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 110.00 // mm
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 187.00 // mm

  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 31.00 // mm

  // Horizontal offset of the universal joints on the carriages.
  #define DELTA_CARRIAGE_OFFSET 20.60 // mm
...
#define Z_CLEARANCE_BETWEEN_PROBES  25 // Z Clearance between probe points	<== THAT'S IT!!!
...
#define HOMING_FEEDRATE_Z  (60*60) // 200x60
